...
function display(field: ChangesetField, value: string | null | undefined) {
  ...
  // The preview carries plain decimals and ISO dates; the euro sign and DD.MM.YYYY are display
  // decisions, and they are the ones every other table in the app makes.
  if (field === 'amount') return formatEur(Math.round(Number(value) * 100))
  return field === 'date' ? formatDate(value) : value
}
