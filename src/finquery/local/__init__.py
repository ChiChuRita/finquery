"""The local provider: Gemma 4 E4B, 12B and 26B A4B in-process through llama-cpp-python.

`catalog` says what files are needed, `downloads` gets them, `runtime` keeps the two seats
