...
# and the prompt must be over 60 percent of the budget. The system prompt alone is 2300 tokens
...
# prompt, the summary and the last six turns), measured at 3208 tokens here. The real default is
# 32768, far above any floor. Every ticket that adds a prompt block has had to move this: this
# is the fourth, for the two paragraphs ticket 11 adds about statement PDFs and photos.
BUDGET = 3600
