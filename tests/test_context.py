...
from .conftest import Chat, Scripts, default_profile_id, is_followup_request, is_summary_request, new_conversation

# 60 percent of this is 720 tokens, which the turns below reach after seven of them.
BUDGET = 1200
...
class Recorder:
    """The fast slot for a whole conversation: answers turns, summaries and follow-ups apart."""
...
async def test_every_turn_reports_token_stats_for_the_badge(
    ...
    # Ticket 13 fills this in; the badge already has the slot for it.
