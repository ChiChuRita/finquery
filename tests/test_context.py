...
# and the prompt must be over 60 percent of the budget. The system prompt alone is 2765 tokens
...
# prompt, the summary and the last six turns), measured at 3673 tokens here. The real default is
# 32768, far above any floor. Every ticket that adds a prompt block has had to move this: this
# is the seventh, for ticket 27's paragraph on cards never being typed, on top of ticket 22's
# prompt rules, ticket 10's duplicates block and ticket 11's two paragraphs about statement PDFs
# and photos. 4500 leaves about 18 percent of headroom over the floor.
BUDGET = 4500
