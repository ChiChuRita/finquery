...
| `chart-benchmark.json` | 69 chart requests: each with the shape it should get, the shapes that would do as well, the column roles, the reference SQL and its rows |
...
the examples: 50 of the 152 questions and 23 of the 69 charts. The rule is
