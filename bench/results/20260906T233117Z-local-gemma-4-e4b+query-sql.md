...
459 datapoints, 2026-09-06T23:31:17+00:00, 7127.8 s in total, 15.5 s per datapoint, median 14.3 s, p90 21.9 s.

| | n | figure match | SQL valid | first attempt | median s |
| --- | ---: | ---: | ---: | ---: | ---: |
| **all** | 459 | 78 % | 98 % | 91 % | 14.3 |
| breakdown | 59 | 73 % | 95 % | 83 % | 13.4 |
| comparison | 38 | 76 % | 97 % | 82 % | 16.5 |
| entity | 69 | 83 % | 97 % | 94 % | 14.7 |
| follow-up | 77 | 75 % | 100 % | 88 % | 14.8 |
| period | 58 | 81 % | 100 % | 97 % | 14.8 |
| ranking | 39 | 64 % | 95 % | 82 % | 14.4 |
| total | 62 | 86 % | 100 % | 98 % | 12.9 |
| trend | 57 | 81 % | 98 % | 95 % | 13.3 |
| difficulty 1 | 67 | 94 % | 100 % | 98 % | 12.9 |
| difficulty 2 | 211 | 80 % | 99 % | 93 % | 13.8 |
| difficulty 3 | 181 | 70 % | 97 % | 85 % | 15.6 |
...
- `g007-ranking` Welche 5 Haendler hatten 2025 den hoechsten Durchschnittsbetrag pro Bu - The query sub-agent did not return a statement: Exceeded maximum output retries (1)
...
- `g013-entity` Wie viel habe ich 2025 monatlich fuer die Allianz Versicherung bezahlt - The query sub-agent did not return a statement: Exceeded maximum output retries (1)
...
- `t64-w01-shipped-en-003` do i spend more on takeaway or in restaurants? - The query sub-agent did not return a statement: Exceeded maximum output retries (1)
...
- `t64-w09-shipped-de-009` War der Dezember teurer als der November? - wrong figures
...
- `t64-w09-shipped-en-015` How does my grocery spending split across supermarket, bakery and drug - The query was refused 2 times, last reason: row value misused
...
- `t64-w17-shipped-en-011` Which five categories ate the most of my salary in 2025? - The query sub-agent did not return a statement: Exceeded maximum output retries (1)
...
- `t64-w21-shipped-en-004` split my grocery spend for 2025 into the subcategories, and give me th - The query was refused 2 times, last reason: ORDER BY clause should come after UNION ALL not before
